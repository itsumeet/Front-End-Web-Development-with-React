...
class Contact extends Component {
  ...
  handleSubmit(event) {
    console.log('current State is: ' + JSON.stringyfy(this.state));
    alert('current State is: ' + JSON.stringyfy(this.state));
...
validate(firstname, lastname, telnum, email) {
  ...
  if(this.state.touched.telnum && !reg.test(telnum))
      ...
      errors.telnum = 'Tel. Number should eb less than 10 characters';
